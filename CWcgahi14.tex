...
Considering the fact that sparse representation is based on an \emph{overcomplete} basis (Olshausen and Field 1996), we use concepts similar to that of inner-products and orthogonal decompositions to aid our feature selection. Overcomplete basis emerges as a natural result of the \emph{sparsity} constraint, .
...
\begin{figure}[!h]
		\centering
		\includegraphics[width=3.0in]{figures_dir/system_query.png}
		\caption{Proposed system.}
		\label{fig:framework}
\end{figure}
\subsection{Image Preprocessing}
Before feeding into the system, all images including those used for dictionary training are whitened to...
...
Sparse-based dictionary learning has been proved to be especially effective in capturing discriminative features of scene images. 
